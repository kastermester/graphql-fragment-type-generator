import { GraphQLList, GraphQLNonNull, GraphQLObjectType, GraphQLOutputType, GraphQLScalarType } from 'graphql';
export declare type NullableFragmentType = ObjectType | ListType | ScalarType;
export declare type FragmentType = NullableFragmentType | NonNullType;
